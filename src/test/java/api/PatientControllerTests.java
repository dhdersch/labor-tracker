...
public class PatientControllerTests {
    ...
    public void noParamUserShouldReturnDefaultMessage() throws Exception {
        ...
        this.mockMvc.perform(get("/user")).andDo(print()).andExpect(status().isOk())
                .andExpect(jsonPath("$.emailAddress").value("Hello, World!"));
    }

    @Test
    public void paramUserShouldReturnTailoredMessage() throws Exception {

        this.mockMvc.perform(get("/user").param("first_name", "Spring Community"))
                .andDo(print()).andExpect(status().isOk())
                .andExpect(jsonPath("$.emailAddress").value("Hello, Spring Community!"));
    }
...
//        FHIRConnection.getInstance().getBMI(user);
    }
